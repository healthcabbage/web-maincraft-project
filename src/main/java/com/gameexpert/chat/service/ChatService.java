...
public class ChatService {
    ...
    public ChatMessageResponse saveMessage(Long worldId, String sender, String content) {
        ...
        World world = worldRepository.findById(worldId).orElseThrow(() -> new NotFoundException("World not found"));
    ...
    public List<ChatMessageResponse> getRecentMessages(Long worldId, int limit) {
        ...
        //return List.of();
        return recent.stream().map(message->savedResponse(worldId, message)).toList();
    }
